...
const teamsData = [
  ...
  { id:"Clube do Inferno", name:"Clube do Inferno", tags:["Mutante", "Controle"], description:"Conclave esotérico e caos controlado.", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/c/c1/Emma_Frost_%28Modern%29.webp.png/250px-Emma_Frost_%28Modern%29.webp.png", members:["Emma Frost","Madelyne Pryor","Azazel","Sebastian Shaw","Rachel Summer"], powerScore: 92, attackers:[{name:"Submundo e Kestrel", attackerPower: 0, defenderPower: 0},{name:"Iluminati", attackerPower: 0, defenderPower: 0},{name:"Mercenarios Pagos", attackerPower: 6333524, defenderPower: 6399470},{name:"Imortais e Gorr Treinador/Knul/Knul Ares", attackerPower: 0, defenderPower: 0},{name:"Imortais Quasar", attackerPower: 5073407, defenderPower: 7906489},{name:"Imortais e Vampira", attackerPower: 6099197, defenderPower: 5131408},{name:"Força V", attackerPower:9287728 , defenderPower:7881511 },{name:"Knowhere cav neg", attackerPower: 5953045, defenderPower: 5809233}], strategy: { text: "Esta é uma defesa de controle de combate (CC).", positioning: ["Rachel Summer", "Emma Frost", "Azazel", "Madelyne Pryor", "Sebastian Shaw"], buffs: ["Lentidão (Inicial - Rachel)", "Barreira (Sebastian Shaw)"] }},
  { id:"Clube do Inferno Mefisto", name:"Clube do Inferno Mefisto", tags:["Mutante", "Controle"], description:"Luxúria, poder e perdição selados por fogo eterno.", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/c/c1/Emma_Frost_%28Modern%29.webp.png/250px-Emma_Frost_%28Modern%29.webp.png", members:["Mefisto","Madelyne Pryor","Azazel","Sebastian Shaw","Rachel Summer"], powerScore: 92, attackers:[{name:"UCM", attackerPower: 12139427, defenderPower: 6090787}], strategy: { text: "Esta é uma defesa de controle de combate (CC).", positioning: ["Rachel Summer", "Emma Frost", "Azazel", "Madelyne Pryor", "Sebastian Shaw"], buffs: ["Lentidão (Inicial - Rachel)", "Barreira (Sebastian Shaw)"] }},
  { id:"Clube do Inferno Cavaleiro Negro", name:"Clube do Inferno Cavalheiro Negro", tags:["Mutante", "Controle"], description:"Luxúria, poder e perdição selados por fogo eterno.", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/c/c1/Emma_Frost_%28Modern%29.webp.png/250px-Emma_Frost_%28Modern%29.webp.png", members:["Cavaleiro Negro","Madelyne Pryor","Azazel","Sebastian Shaw","Rachel Summer"], powerScore: 92, attackers:[{name:"Imortais Ares", attackerPower: 5913775, defenderPower: 5585738}], strategy: { text: "Esta é uma defesa de controle de combate (CC).", positioning: ["Rachel Summer", "Emma Frost", "Azazel", "Madelyne Pryor", "Sebastian Shaw"], buffs: ["Lentidão (Inicial - Rachel)", "Barreira (Sebastian Shaw)"] }},

  { id:"UCM", name:"UCM", tags:["Bio", "Tech", "Sinergia"], description:"Unidos pelo destino, imparáveis na batalha!", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Fantastic_Four_logo_%28blue_and_white%29.svg/250px-Fantastic_Four_logo_%28blue_and_white%29.svg.png", members:["Tocha Humana","Mulher Invisivel","O coisa","Franklin Richards","Senhor Fantastico"], powerScore: 88, attackers:[{name:"Mercenarios Pagos e Scarlet Zumbi", attackerPower: 5321751, defenderPower: 8403828},{name:"Mercenarios Pagos e Quasar", attackerPower: 0, defenderPower: 0},{name:"Mercenarios Pagos Quasar e Ares", attackerPower: 0, defenderPower: 0},{name:"Ares Mef Apo Kang Quasar", attackerPower: 0, defenderPower: 0}]},
  { id:"UCM Mefisto", name:"UCM Mefisto", tags:["Bio", "Tech", "Sinergia"], description:"Unidos pelo destino, imparáveis na batalha!", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Fantastic_Four_logo_%28blue_and_white%29.svg/250px-Fantastic_Four_logo_%28blue_and_white%29.svg.png", members:["Tocha Humana","Mulher Invisivel","O coisa","Franklin Richards","Senhor Fantastico"], powerScore: 88, attackers:[{name:"Perseguidores Noturno Apo", attackerPower: 0, defenderPower: 0},{name:"Astral Motoqueiro Cosmico", attackerPower: 9174257, defenderPower: 6655930},{name:"Gorr Knul Apo Odin Gladiador", attackerPower: 8774529, defenderPower: 7652750}]},
  { id:"Amaldiçoados", name:"Amaldiçoados", tags:["Místico", "Sustentação"], description:"Da sombras surgimos... e nelas deixamos nossos inimigos!", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/2/29/Bloodborne_capa.png/330px-Bloodborne_capa.png", members:["Juggernaut","Mordo","Capuz","Satana","hellverine"], powerScore: 95, attackers:[{name:"Submundo", attackerPower: 0, defenderPower: 0},{name:"Submundo daken(nobu)", attackerPower: 0, defenderPower: 0},{name:"Força A", attackerPower: 0, defenderPower: 0},{name:"Knowhere Quasar", attackerPower: 0, defenderPower: 0},{name:"Mente coletiva e Knul", attackerPower: 0, defenderPower: 0},{name:"Cabal com Apo e kang", attackerPower: 0, defenderPower: 0},{name:"cabal com apo e mefisto", attackerPower: 0, defenderPower: 0},{name:"Mercenarios Pagos", attackerPower: 0, defenderPower: 0},{name:"Fora do Tempo", attackerPower: 0, defenderPower: 0},{name:"Orquidea", attackerPower: 0, defenderPower: 0},{name:"imortais e ares", attackerPower: 0, defenderPower: 0},{name:"força v", attackerPower: 0, defenderPower: 0},{name:"Poderosos Vingadores", attackerPower: 6890543, defenderPower: 6393296},{name:"fabulosos vingadores", attackerPower: 0, defenderPower: 0},{name:"liberdade", attackerPower: 0, defenderPower: 0},{name:"Perseguidores Noturno", attackerPower: 6452219, defenderPower: 7249972},{name:"ucm", attackerPower: 0, defenderPower: 0},{name:"clube do inferno", attackerPower: 0, defenderPower: 0},{name:"Thunderbolts", attackerPower: 7808777, defenderPower: 6983365}], strategy: { text: "Defesa com foco em Dano com o HELLVERINE.", positioning: ["Satana", "hellverine", "Juggernaut", "Mordo", "Capuz"], buffs: ["Provocação (Juggernaut)", "Cura (Mordo)", "Regeneração (Hellverine)"] }},
  ...
  { id:"Thunderbolts", name:"Thunderbolts", tags:["Habilidade", "Dano", "Controle"], description:"Os thunderbolts entram em cena - caos, força e rendenção em cada golpe!", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/a/a3/Thunderbolts_Vol_2_1.jpg/250px-Thunderbolts_Vol_2_1.jpg", members:["Hiperion","Treinador","Victoria Hand","Fantasma","Soprano"], powerScore: 82, attackers:[{name:"Iluminati e odin", attackerPower: 0, defenderPower: 0},{name:"Mercenarios Pagos", attackerPower: 2470180, defenderPower: 8805590},{name:"Imortais Ares", attackerPower: 0, defenderPower: 0},{name:"Força V", attackerPower: 0, defenderPower: 0},{name:"Poderosos Vingadores", attackerPower: 6266707, defenderPower: 7039770},{name:"Fabulosos Vingadores", attackerPower: 0, defenderPower: 0},{name:"Liberdade", attackerPower: 10703509, defenderPower: 5954892},{name:"Perseguidores Noturno", attackerPower: 0, defenderPower: 0},{name:"UCM", attackerPower: 0, defenderPower: 0},{name:"Clube do Inferno", attackerPower: 0, defenderPower: 0},{name:"Sexteto Insiduoso Vulture/Schoker", attackerPower: 7367347, defenderPower: 7459671}]},
  ...
  { id:"Tropa Alfa Doom", name:"Tropa Alfa Doom", tags:["Mutante", "Sinergia"], description:"Pode estelar,fúria e maldição em guerra pelo cosmos", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/3/31/TrpAlfa.jpg/250px-TrpAlfa.jpg", members:["Estrela Polar","Sasquatch","Guardião","Doom","Solaris"], attackers:[{name:"Perseguidores Noturno Apo", attackerPower: 4354483, defenderPower: 4561594}]},
  ...
  { id:"Orquidea", name:"Orquidea", tags:["Tech", "Anti-Mutante"], description:"Beleza letal, florescendo em meio ao caos.", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Nim-logo.png/330px-Nim-logo.png", members:["Nimrod","Sentinela Omega","Lady letal","Sentienela","Cientista Suprema"], powerScore: 92, attackers:[{name:"Mente coletiva e Skrul", attackerPower: 0, defenderPower: 0},{name:"Def sec Apo", attackerPower: 0, defenderPower: 0},{name:"Iluminati", attackerPower: 5147701, defenderPower: 7849837},{name:"Iluminati Apo", attackerPower: 5308062, defenderPower: 7685666},{name:"Cabal Ares Apo", attackerPower: 0, defenderPower: 0},{name:"Mercenarios pagos", attackerPower: 0, defenderPower: 0},{name:"Mercenarios pagos Apo", attackerPower: 5382706, defenderPower: 7691375},{name:"Fora do tempo Quasar", attackerPower: 0, defenderPower: 0},{name:"Imortais venom/mancha/emma/vampira/vahl", attackerPower: 0, defenderPower: 0},{name:"Imortais Dormu/Quasar/Odin", attackerPower: 0, defenderPower: 0},{name:"Força V e com odin", attackerPower: 0, defenderPower: 0},{name:"Astral", attackerPower: 0, defenderPower: 0},{name:"Poderosos Vingadores", attackerPower: 9016774, defenderPower: 7343266},{name:"Liberdade", attackerPower: 0, defenderPower: 0},{name:"Vigilantes", attackerPower: 10224207, defenderPower: 7567021},{name:"Perseguidores noturno", attackerPower: 8073122, defenderPower: 7953401},{name:"Thunderbolts", attackerPower: 0, defenderPower: 0},{name:"UCM", attackerPower: 0, defenderPower: 0},{name:"Clube do inferno", attackerPower: 0, defenderPower: 0}]},
  ...
  { id:"Novos Vingadores", name:"Novos Vingadores", tags:["Habilidade", "Sinergia"], description:"Novos heróis, mesma determinação de salvar o mundo.", image:"https://seriesemcena.com.br/wp-content/uploads/2019/01/Dw_9XoLVYAEvC23.jpg", members:["Agente Coulson","Tigresa","Ronin","O Coisa","Harpia"], attackers:[{name:"Cabal Apo Ultimus", attackerPower: 0, defenderPower: 0},{name:"Fora do Tempo", attackerPower: 0, defenderPower: 0},{name:"Imortais Vahl/Apo", attackerPower: 0, defenderPower: 0},{name:"Mercenarios Pago", attackerPower: 4722034, defenderPower: 4648646},{name:"Thunderbolts", attackerPower: 7989749, defenderPower: 3839784},{name:"Força V", attackerPower: 4187666, defenderPower: 2964642}]},
  ...
  { id:"Infestação", name:"Infestação", tags:["Bio", "Debuff"], description:"Quanto mais tentam nos deter, mais nos multiplicamos.", image:"https://preview.redd.it/37ighsq9jr031.jpg?auto=webp&s=5b336efab8ddb4a717cf1cf0479e143720c50252", members:["Big Time","Enxame","Viuva Negra","Homem Formiga","Jaqueta Amarela"], attackers:[{name:"Knowhere", attackerPower: 0, defenderPower: 0},{name:"Sexteto de Guerra", attackerPower: 4294519, defenderPower: 6427365},{name:"Imortais Wheave/Ares", attackerPower: 0, defenderPower: 0},{name:"Perseguidores Noturno Ares", attackerPower: 0, defenderPower: 0},{name:"UCM", attackerPower: 0, defenderPower: 0},{name:"Insiduosos Shocker Lagarto", attackerPower: 6487899, defenderPower: 9177350}]},
  ...
  { id:"Submundo blaastar", name:"Submundo Blaastar", tags:["Habilidade", "Controle"], description:"Das profundezas à conquista, o caos agora tem um trono.", image:"https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjzjKanLoo8KLnoSewf917P369wvNrQ6l7IK2dolNMCS-xAou_UN59BGsgmy3-Bi-izEdF6I_dHznsSBR8kCuvX05AUTodVn6O4L_4x4J7tS6yNFowMobLJOEk8aD8SPKKC4pNjvtgwwJTQ/s1600/Marvel+diversity.jpg", members:["Kingpin","Blaastar","Senhor Negativo","Duende Verde","Treinador"], attackers:[{name:"Orquidea", attackerPower: 8792494, defenderPower: 3360610}]},
  ...
  { id:"Knowhere", name:"Knowhere", tags:["Cósmico", "Sinergia"], description:"No vazio do cosmos, somos tudo e nada.", image:"https://upload.wikimedia.org/wikipedia/pt/0/0e/Rocket_Raccoon.jpg", members:["Nova","Korg","Cosmo","Thor","Star lord Aniquilação"], attackers:[{name:"Imortais Vespa", attackerPower: 0, defenderPower: 0},{name:"Força V", attackerPower: 0, defenderPower: 0},{name:"Cabala kang Apo", attackerPower: 6179410, defenderPower: 3262924}]},
  ...
  { id:"Tropa Alfa Skrul", name:"Tropa Alfa Skrul", tags:["Mutante", "Controle"], description:"Quando a Força estelar encontra a astúcia das sombras.", image:"https://upload.wikimedia.org/wikipedia/pt/thumb/3/31/TrpAlfa.jpg/250px-TrpAlfa.jpg", members:["Estrela Polar","Sasquatch","Guardião","Solaris","Skrul"], attackers:[{name:"Mercenarios Pago", attackerPower: 2784283, defenderPower: 4250752},{name:"Imortais Ares", attackerPower: 3066940, defenderPower: 4944758},{name:"Imortais Doom/Mefisto/Knul/Quasar", attackerPower: 0, defenderPower: 0},{name:"Perseguidores Noturno", attackerPower: 7985272, defenderPower: 4158704}]},
  ...
  { id:"X-tremo Vampira", name:"X-tremo Vampira", tags:["Mutante", "Dano", "Sustentação"], description:"Poder roubado, força sem limites.", image:"https://upload.wikimedia.org/wikipedia/pt/a/ac/Gambit.jpg", members:["Noturno","Gambit","Forge","Mancha Solar","Vampira"], attackers:[{name:"Gama", attackerPower: 0, defenderPower: 0},{name:"Def Sec Apo ou Def Sec Omega Knul", attackerPower: 0, defenderPower: 0},{name:"Knowhere", attackerPower: 0, defenderPower: 0},{name:"Sexteto de Guerra", attackerPower: 0, defenderPower: 0},{name:"Cabala Kang Apo", attackerPower: 0, defenderPower: 0},{name:"Força V", attackerPower: 0, defenderPower: 0},{name:"Liberdade", attackerPower: 6212607, defenderPower: 4344239},{name:"Orquidea", attackerPower: 7971404, defenderPower: 4694250}]},
  ...
  { id:"Força Fênix Mutantes", name:"Força Fênix Mutantes", tags:["Mutante", "Dano", "Controle"], description:"Renascendo das cinzas, poder ilimitado em nossas maõs.", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Nuremberg_chronicles_-_Phoenix_%28CIIIIv%29.jpg/250px-Nuremberg_chronicles_-_Phoenix_%28CIIIIv%29.jpg", members:["Fênix","Omega","Mutantes"], attackers:[{name:"Mente Coletiva Knul", attackerPower: 0, defenderPower: 0},{name:"Novos Vingadores", attackerPower: 0, defenderPower: 0},{name:"Sexteto de Guerra", attackerPower: 0, defenderPower: 0},{name:"Sociedade Aranha Skrul", attackerPower: 0, defenderPower: 0},{name:"Mercenarios Pago", attackerPower: 0, defenderPower: 0},{name:"Fora do Tempo", attackerPower: 0, defenderPower: 0},{name:"Imortais Treinador Gorr", attackerPower: 0, defenderPower: 0},{name:"Iluminati", attackerPower: 0, defenderPower: 0},{name:"Orquidea", attackerPower: 8666451, defenderPower: 6777671},{name:"Força V", attackerPower: 0, defenderPower: 0},{name:"Perseguidores Noturno", attackerPower: 0, defenderPower: 0},{name:"UCM", attackerPower: 0, defenderPower: 0},{name:"Gama", attackerPower: 5685310, defenderPower: 5591121}]},
  ...
  { id:"Força V  Dormammu Skrul", name:"Força V  Dormammu Skrul", tags:["Sinergia", "Cósmico"], description:"A mente e o caos unidos para reescrever a realidade.", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Coat_of_arms_of_the_Brazilian_Air_Force.svg/250px-Coat_of_arms_of_the_Brazilian_Air_Force.svg.png", members:["Kahhori","Medusa","Ms. Marvel Classica","Professor X","Dormammu"], attackers:[{name:"Brimstone Quasar (hellcat)", attackerPower: 6608243, defenderPower: 4545900}]},
  { id:"Força V  Mefisto Skrul", name:"Força V  Mefisto Skrul", tags:["Sinergia", "Cósmico"], description:"A mente e o caos unidos para reescrever a realidade.", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Coat_of_arms_of_the_Brazilian_Air_Force.svg/250px-Coat_of_arms_of_the_Brazilian_Air_Force.svg.png", members:["Kahhori","Medusa","Ms. Marvel Classica","Mefisto","Skrul"], attackers:[{name:"Força V Knul Blaastar", attackerPower: 9007944, defenderPower: 8364530}]},
...
function renderSimulator() {
  ...
  // Modificado: Mapeia por NOME para o datalist
  const teamOptions = availableAttackers.map(t => `<option value="${t.name}"></option>`).join('');

  // HTML do simulador reestruturado e estilizado
  simulatorContainer.innerHTML = `
    <div class="sim-header">
      <h3><span class="sim-icon">⚔️</span> Análise de Batalha</h3>
      <p>Defensor: <strong>${currentDefenseTeam.name}</strong></p>
    </div>
    ...
    <div class="sim-grid">
      <div class="sim-controls-wrapper">
        ...
        <div class="sim-controls">
          <strong>1. Time Atacante de Referência:</strong>
          <input type="text" id="attackerSearchInput" list="attackerDatalist" placeholder="Digite o nome do time atacante..." />
          <datalist id="attackerDatalist">
            ${teamOptions}
          </datalist>
          
          <strong>2. Poder do Time Defensor:</strong>
          <input type="number" id="defenderPowerInput" placeholder="Ex: 1200000" />
          
          <strong>3. Poder do SEU Time Atacante:</strong>
      ...
      <div class="sim-result-wrapper">
        <h4>Resultado da Análise</h4>
        <div id="simResultArea" class="sim-result">
          <div id="battleBreakdown" class="battle-breakdown" style="text-align:center; color:var(--muted); font-style:italic;">
            Preencha os campos e clique em "Analisar Força" para ver o resultado.
          </div>
        </div>
      </div>
    </div>
...
function runSimulation() {
  ...
  // Modificado: Pega o valor pelo nome do input
  const selectedAttackerName = $('#attackerSearchInput').value;
  // Modificado: Encontra o time pelo NOME
  const attacker = teamsData.find(t => t.name.toLowerCase() === selectedAttackerName.toLowerCase());
  
  const defenderPower = parseInt($('#defenderPowerInput').value);
  const yourAttackerPower = parseInt($('#yourAttackerPowerInput').value);

  // Adicionada verificação para time atacante inválido
  if (!attacker) {
    resultArea.className = 'sim-result is-bad';
    breakdownEl.innerHTML = `⚠️ <strong class="bad">Time atacante não encontrado.</strong><br>Por favor, selecione um time válido da lista.`;
    return;
  }
  ...
  // resultArea.style.display = 'block'; // Não é mais necessário, está sempre visível
  ...
  if (knownAttack && knownAttack.defenderPower > 0 && knownAttack.attackerPower > 0) {
    ...
    if (powerDifferencePct >= 5) {
      ...
      resultArea.className = 'sim-result'; // Cor neutra
    ...
    breakdownEl.innerHTML = `
      ...
      <hr>
      ${resultText}<br>
      <small style="font-style:italic;">${adviceText}</small>
    `;
    
  } else {
    resultArea.className = 'sim-result'; // Cor neutra
    breakdownEl.innerHTML = `
      <strong style="color:var(--accent-2);">Confronto Não Listado.</strong><br>
      Não há dados de referência para <strong>${attacker.name}</strong> atacando <strong>${currentDefenseTeam.name}</strong>.<br>
      <small style="font-style:italic;">O simulador só funciona para confrontos com dados de referência. Tente outro time atacante.</small>
    `;
  }
}
